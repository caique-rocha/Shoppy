...
import com.google.codelabs.appauth.fragments.ChangePasswordDialog;
...
public class ProfileActivity extends AppCompatActivity implements ChangePasswordDialog.Listener {
    ...
    private void initViews() {
        ...
        mBtChangePassword.setOnClickListener(view -> startActivity(new Intent(ProfileActivity.this, MainActivity.class)));
